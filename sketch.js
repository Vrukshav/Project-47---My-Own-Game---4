...
function draw() {
  ...
  || bird.isTouching(wall19)  || bird.isTouching(wall31)  || bird.isTouching(wall43)  || bird.isTouching(wall16) 
  || bird.isTouching(wall20)  || bird.isTouching(wall32)  || bird.isTouching(wall44)  || bird.isTouching(wall17) 
  || bird.isTouching(wall21)  || bird.isTouching(wall33)  || bird.isTouching(wall45)  || bird.isTouching(wall54) 
  || bird.isTouching(wall22)  || bird.isTouching(wall34)  || bird.isTouching(wall46)  
  || bird.isTouching(wall23)  || bird.isTouching(wall35)  || bird.isTouching(wall47)  ){
     bird.isTouching(wall24)  || bird.isTouching(wall36)  || bird.isTouching(wall48)   
  || bird.isTouching(wall25)  || bird.isTouching(wall37)  || bird.isTouching(wall49)  
  || bird.isTouching(wall26)  || bird.isTouching(wall38)  || bird.isTouching(wall50)   
  || bird.isTouching(wall27)  || bird.isTouching(wall39)  || bird.isTouching(wall51) 
  || bird.isTouching(wall28)  || bird.isTouching(wall40)  || bird.isTouching(wall52)   
  || bird.isTouching(wall29)  || bird.isTouching(wall41)  || bird.isTouching(wall53)   
    gameState = END
